...
(custom-set-variables
 ...
 '(package-selected-packages
   '(wl-clipboard base16-theme orderless corfu-terminal move-text almost-mono-themes helm-projectile fzf flx cape corfu goto-chg iedit sly phi-search iy-go-to-char ocamlformat auto-complete flycheck-popup-tip flycheck-pos-tip flycheck-eglot popper pulsar swiper-helm markdown-preview-mode blamer auto-package-update benchmark-init undo-tree esup helm-grepint consult-flycheck consult-embark embark consult catppuccin-theme writegood-mode minimap hydra multiple-cursors ewal-doom-themes ewal-spacemacs-themes helm emacs-async gdscript-mode ewal rainbow-mode git-gutter qml-mode projectile leuven-theme doom-themes rust-mode rainbow-delimiters ace-window use-package smex nyan-mode go-playground gotest go-errcheck bongo vterm swoop helm-swoop helm-ag elcord flycheck-google-cpplint flycheck-golangci-lint exec-path-from-shell neotree go-mode atom-one-dark-theme lua-mode latex-preview-pane auctex fic-mode smooth-scrolling flycheck))
...
(custom-set-faces
 ...
 '(company-preview-common ((t (:background "#3A3A3A" :foreground "cornflowerblue"))))
 ...
 '(company-tooltip-scrollbar-thumb ((t (:background "cornflowerblue"))))
 '(company-tooltip-search ((t (:background "cornflowerblue" :foreground "#212121" :weight bold))))
 ...
 '(helm-buffer-process ((t (:extend t :foreground "plum"))))
 '(helm-buffer-saved-out ((t (:extend t :foreground "plum"))))
...
(use-package base16-theme
  ...
  (load "~/.emacs.d/base16-bluecake-theme.el"))
...
(defun setup-window ()
  ...
  (load-theme 'base16-bluecake)
  (if (display-graphic-p (selected-frame))
      (progn
        ;; Configurations specific to windowed mode
        (setq select-enable-clipboard 1)
        ;; (set-background-color "#FFFFFF")
        (set-frame-font "-TAB -ComicCodeLigatures Nerd Font-medium-normal-normal-*-18-*-*-*-m-0-iso10646-1")
        (nyan-mode 1))
    (progn
