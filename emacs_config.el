...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flx popup wl-clipboard base16-theme orderless corfu-terminal helm-projectile fzf cape corfu goto-chg iedit sly phi-search popper pulsar swiper-helm blamer auto-package-update benchmark-init undo-tree helm-grepint consult-flycheck consult writegood-mode hydra multiple-cursors helm emacs-async gdscript-mode rainbow-mode git-gutter qml-mode projectile doom-themes rust-mode rainbow-delimiters ace-window use-package smex nyan-mode go-playground gotest go-errcheck bongo swoop helm-swoop helm-ag elcord flycheck-google-cpplint flycheck-golangci-lint exec-path-from-shell neotree go-mode lua-mode fic-mode smooth-scrolling flycheck))
...
(custom-set-faces
 ...
 '(pulsar-generic ((t (:inherit pulsar-green :extend t))))
...
(defun setup-window ()
  ...
  (load-theme 'base16-corin-halloween)
